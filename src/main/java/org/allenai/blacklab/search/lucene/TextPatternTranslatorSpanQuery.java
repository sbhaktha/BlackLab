...
import org.allenai.blacklab.search.sequences.SpanQueryExpansion;
import org.allenai.blacklab.search.sequences.SpanQueryRepetition;
import org.allenai.blacklab.search.sequences.SpanQuerySequence;
...
public class TextPatternTranslatorSpanQuery extends TextPatternTranslator<SpanQuery> {
	...
	public SpanQuery tags(QueryExecutionContext context, String elementName, Map<String, String> attr) {
		...
		return new SpanQueryPositionFilter(allTags, filter, SpanQueryPositionFilter.Filter.STARTS_AT);
	}
