 ...
 *******************************************************************************/
package org.allenai.blacklab.search.lucene;

import java.io.IOException;

import org.allenai.blacklab.search.Span;
import org.allenai.blacklab.search.sequences.SpanComparatorStartPoint;
import org.allenai.blacklab.search.sequences.SpansInBucketsPerDocument;
import org.allenai.blacklab.search.sequences.SpansInBucketsPerDocumentSorted;
...
class SpansPositionFilter extends BLSpans {
	 ...
	 */
	private SpanQueryPositionFilter.Filter op;
	...
	public SpansPositionFilter(Spans containers, Spans filter) {
		this(containers, filter, SpanQueryPositionFilter.Filter.CONTAINING);
	}
