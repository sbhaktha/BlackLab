package org.allenai.blacklab.search.indexstructure;
...
public class PropertyDesc {
	...
	private ComplexFieldProperty.SensitivitySetting sensitivity = ComplexFieldProperty.SensitivitySetting.ONLY_SENSITIVE;
...
//			altDesc = ", with alternative \"" + altList + "\"";
		...
		if (alternatives.containsKey("s")) {
			if (alternatives.containsKey("i")) {
				if (alternatives.containsKey("ci")) {
					sensitivity = ComplexFieldProperty.SensitivitySetting.CASE_AND_DIACRITICS_SEPARATE;
				} else {
					sensitivity = ComplexFieldProperty.SensitivitySetting.SENSITIVE_AND_INSENSITIVE;
				}
			} else {
				sensitivity = ComplexFieldProperty.SensitivitySetting.ONLY_SENSITIVE;
			}
		} else {
			sensitivity = ComplexFieldProperty.SensitivitySetting.ONLY_INSENSITIVE;
		}
	}
	 ...
	 */
	public ComplexFieldProperty.SensitivitySetting getSensitivity() {
		return sensitivity;
	}
	...
	public boolean hasAlternative(String alt) {
		if (alt.equals("s")) {
			return sensitivity != ComplexFieldProperty.SensitivitySetting.ONLY_INSENSITIVE;
		} else if (alt.equals("i")) {
			return sensitivity != ComplexFieldProperty.SensitivitySetting.ONLY_SENSITIVE;
		} else if (alt.equals("ci") || alt.equals("di")) {
			return sensitivity == ComplexFieldProperty.SensitivitySetting.CASE_AND_DIACRITICS_SEPARATE;
		}
