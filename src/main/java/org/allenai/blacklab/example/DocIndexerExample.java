...
public class DocIndexerExample extends DocIndexerXmlHandlers {
	public DocIndexerExample(Indexer indexer, String fileName, Reader reader) {
		...
		final ComplexFieldProperty propLemma = addProperty("lemma", ComplexFieldProperty.SensitivitySetting.SENSITIVE_AND_INSENSITIVE);
		final ComplexFieldProperty propPartOfSpeech = addProperty("pos", ComplexFieldProperty.SensitivitySetting.ONLY_INSENSITIVE);
