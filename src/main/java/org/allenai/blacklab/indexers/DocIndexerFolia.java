...
public class DocIndexerFolia extends DocIndexerXmlHandlers {
	...
	public DocIndexerFolia(Indexer indexer, String fileName, Reader reader) {
		...
		addHandler("lemma", new HookableSaxHandler.ElementHandler() {
			@Override
			public void startElement(String uri, String localName, String qName,
					Attributes attributes) {
				super.startElement(uri, localName, qName, attributes);
		...
		addHandler("pos", new HookableSaxHandler.ElementHandler() {
			@Override
			public void startElement(String uri, String localName, String qName,
					Attributes attributes) {
				super.startElement(uri, localName, qName, attributes);
		...
		addHandler("w/t", new HookableSaxHandler.ContentCapturingHandler() {
		...
		addHandler("meta", new HookableSaxHandler.ContentCapturingHandler() {
