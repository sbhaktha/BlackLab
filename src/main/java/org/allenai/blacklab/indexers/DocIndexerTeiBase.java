 ...
 *******************************************************************************/
package org.allenai.blacklab.indexers;

import java.io.Reader;

import org.allenai.blacklab.index.DocIndexerXmlHandlers;
...
import org.allenai.blacklab.index.HookableSaxHandler;
...
public abstract class DocIndexerTeiBase extends DocIndexerXmlHandlers {
	...
	public void init() {
		...
		final HookableSaxHandler.ElementHandler body = addHandler(contentElement, new HookableSaxHandler.ElementHandler() {
			@Override
		...
		addHandler("listBibl", new HookableSaxHandler.ElementHandler() {
		...
		addHandler("interpGrp", new HookableSaxHandler.ElementHandler() {
			@Override
			public void startElement(String uri, String localName, String qName,
					Attributes attributes) {
				consumeCharacterContent(); // clear it to capture punctuation and words
		...
		addHandler("interp", new HookableSaxHandler.ElementHandler() {
			@Override
			public void startElement(String uri, String localName, String qName,
					Attributes attributes) {
