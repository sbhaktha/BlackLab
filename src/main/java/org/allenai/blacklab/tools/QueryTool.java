 ...
 *******************************************************************************/
package org.allenai.blacklab.tools;
...
import org.allenai.blacklab.perdocument.DocResult;
import org.allenai.blacklab.perdocument.DocResults;
import org.allenai.blacklab.perdocument.DocResultsWindow;
import org.allenai.blacklab.queryParser.contextql.ContextualQueryLanguageParser;
import org.allenai.blacklab.queryParser.corpusql.CorpusQueryLanguageParser;
import org.allenai.blacklab.queryParser.lucene.LuceneQueryParser;
import org.allenai.blacklab.queryParser.contextql.TokenMgrError;
import org.allenai.blacklab.search.CompleteQuery;
import org.allenai.blacklab.search.Concordance;
import org.allenai.blacklab.search.ConcordanceType;
import org.allenai.blacklab.search.Hit;
import org.allenai.blacklab.search.Hits;
import org.allenai.blacklab.search.HitsWindow;
import org.allenai.blacklab.search.Searcher;
import org.allenai.blacklab.search.Span;
import org.allenai.blacklab.search.TermFrequency;
import org.allenai.blacklab.search.TermFrequencyList;
import org.allenai.blacklab.search.TextPattern;
import org.allenai.blacklab.search.grouping.GroupProperty;
import org.allenai.blacklab.search.grouping.GroupPropertyIdentity;
import org.allenai.blacklab.search.grouping.GroupPropertySize;
import org.allenai.blacklab.search.grouping.HitGroup;
import org.allenai.blacklab.search.grouping.HitGroups;
import org.allenai.blacklab.search.grouping.HitProperty;
import org.allenai.blacklab.search.grouping.HitPropertyDocumentId;
import org.allenai.blacklab.search.grouping.HitPropertyDocumentStoredField;
import org.allenai.blacklab.search.grouping.HitPropertyHitText;
import org.allenai.blacklab.search.grouping.HitPropertyLeftContext;
import org.allenai.blacklab.search.grouping.HitPropertyMultiple;
import org.allenai.blacklab.search.grouping.HitPropertyRightContext;
import org.allenai.blacklab.search.grouping.HitPropertyWordLeft;
import org.allenai.blacklab.search.grouping.HitPropertyWordRight;
import org.allenai.blacklab.search.indexstructure.ComplexFieldDesc;
import org.allenai.blacklab.search.indexstructure.IndexStructure;
import org.allenai.util.FileUtil;
import org.allenai.util.IoUtil;
import org.allenai.util.LuceneUtil;
import org.allenai.util.StringUtil;
import org.allenai.util.TimeUtil;
import org.allenai.util.Timer;
...
public class QueryTool {
	...
	class ParserCorpusQl extends Parser {
		...
		public TextPattern parse(String query) throws ParseException {
			try {
				...
				return parser.query();
			} catch (org.allenai.blacklab.queryParser.corpusql.ParseException e) {
				throw new ParseException(e.getMessage());
			} catch (org.allenai.blacklab.queryParser.corpusql.TokenMgrError e) {
				throw new ParseException(e.getMessage());
			} catch (Exception e) {
	...
	class ParserContextQl extends Parser {
		...
		public TextPattern parse(String query) throws ParseException {
			...
			} catch (org.allenai.blacklab.queryParser.contextql.ParseException e) {
				throw new ParseException(e.getMessage());
	...
	class ParserLucene extends Parser {
		...
		public TextPattern parse(String query) throws ParseException {
			...
			} catch (org.allenai.blacklab.queryParser.lucene.ParseException e) {
				throw new ParseException(e.getMessage());
			} catch (org.allenai.blacklab.queryParser.lucene.TokenMgrError e) {
				throw new ParseException(e.getMessage());
			} catch (Exception e) {
				throw new ParseException("Fatale fout tijdens parsen: " + e.getMessage());
			}
