...
public class ComplexField {
	 ...
	 */
	public ComplexField(String name, String mainPropertyName, ComplexFieldProperty.SensitivitySetting sensitivity) {
	...
	public ComplexFieldProperty addProperty(String name, ComplexFieldProperty.SensitivitySetting sensitivity) {
